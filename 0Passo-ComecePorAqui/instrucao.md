Configure seu computador para programar. 

Eu fiz um script para automatizar a criação e ativação do ambiente virtual, a instalação da biblioteca pdf2image e conferência do seu repositório.
